...
import (
	...
	grpc "pikabu-signaling/signaling/pkg/grpc"
	pb "pikabu-signaling/signaling/pkg/grpc/pb"
	http "pikabu-signaling/signaling/pkg/http"
...
var fs = flag.NewFlagSet("signaling", flag.ExitOnError)
...
func Run() {
	...
	*grpcAddr = service.GetConfigServerGrpc()
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "signaling")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterSignalingServer(baseServer, grpcServer)
